...
### Rex Challenge
The first Rex prompt in a Study Session. Its issuance can open an Open Study Session before any Learner Response exists. It does not use "all of the above" or "none of the above" options. The app controls whether it is single-response or multiple-response, using a 60/40 single-to-multiple mix in V1.
