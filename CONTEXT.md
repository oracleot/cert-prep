...
### Open Study Session
A Study Session that exists but has not yet completed its intended Exchanges. This is internal language rather than a learner-visible term.

### Completed Study Session
A Study Session that has completed its intended Exchanges. It does not become Open again; later work creates a new Study Session.
...
### Session Ledger
The canonical record of a Study Session, including its full Exchanges and internal Aborted Exchanges, active/excluded review status, feedback effects, aggregate updates, and read projections for restore/history. A Study Session may move between active and excluded-from-review without being deleted.
