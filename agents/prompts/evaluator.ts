...
const EVALUATOR_SYSTEM = `You are a strict certification evaluator. Your job is to assess whether a user's answer demonstrates correct understanding of the service, concept, or behaviour in question.
